...
div.Kategorie::-webkit-scrollbar-thumb {
    background: #747f55; /* 스크롤바 색상 */
    border-radius: 10px; /* 스크롤바 둥근 테두리 */
}
div.Kategorie::-webkit-scrollbar-track {
    background: rgba(190, 200, 151, 1)  /*스크롤바 뒷 배경 색상*/
}
...
<body>
	...
	<div class="pagename">
		<h1 style="margin: 0 auto; width: 100px;">Shop</h1>
		<br>

		<ul class="shopmenu" style="width: 500px; margin: 0 auto; font-size: 19px;">
	...
	<div class="Kategorie" style="overflow: scroll; width: 15%; float: left; ">
	 <form action="itemck" method="get">
			
			
			<b style="font-size: 20px;">브랜드</b>
		<a href="/item/itemlist"><b style="font-size: 12px; float: right;">선택 초기화</b></a>
		<br>
		<br> 
		...
		<span style="vertical-align: top;">잡화</span></label><br>
			...
			<label><button type="submit"  value="찾아보기" id="findbtn">
			<span style="vertical-align: top;">찾아보기</span></button></label>
			<br> 
	...
	<div style="width: 85%; height: 5100px; border: 0px solid black; margin-left: 15%; margin-bottom: 10%;">
		
		<div >
			
			<b style="float: left; margin-left: 2%;"> 상품 ${totitem } ${stotitem } ${soritem } 개</b> 
				
				
				
				
			<div class="sortitembtn" style="float: right; margin-right: 2%;">
				<a><b id="popsort">인기순</b></a> &nbsp; <a id="namesort" href="itemsort"><b >이름순</b></a>
			</div>
		</div>
		
		
		<div style="margin-left: 12%; border: 0px solid gray;">
			<c:forEach var="a" items="${list}" varStatus="i">
				...
				<div class="imgbox">
					...
					<span class="p"> <b id="brandcolor" style="color: black; font-size: 2em; text-align: ">${a.item_brandname }</b><br>

var List=[
    "조던 1 x 트래비스 스캇 레트로 로우 OG SP 미디움 올리브",
    "조던 1 레트로 하이 OG 시카고",
    "나이키 ACG 스톰핏 ADV 케스케이드 레인 풀 집 자켓 블랙",
    "나이키 NRG 솔로 스우시 우븐 트랙 자켓 블랙",
    "나이키 x 피스마이너스원 롱슬리브 티셔츠 블랙",
    "나이키 x 피스마이너스원 롱슬리브 티셔츠 화이트",
    "나이키 x 피스마이너스원 와이드 팬츠 블랙",
    ...
    "스톤 아일랜드 101WN 브러쉬드 코튼 캔버스 올드이펙트 오버셔츠 블랙",
    "스톤 아일랜드 40522 크링클랩스 나일론 가먼트 다이드 후드 자켓 블랙",
    "스톤 아일랜드 B0943 나일론 메탈 스위밍 트렁크 블랙",
    "스톤 아일랜드 B0943 나일론 메탈 스위밍 트렁크 스카이 블루",
    "스투시 ITP 플라워 티셔츠 화이트",

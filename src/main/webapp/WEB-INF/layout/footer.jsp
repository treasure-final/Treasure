...
<div style="margin-left: 10px; font-size: 13px;  margin-top: 30px;">
      ...
      <a href="#">
      <img src="../img/footerlogo1.png" style="width: 30px; height: 30px; margin-left: 50px;">
      </a>
      <a href="#">
      <img src="../img/footerlogo3.png" style="width: 30px; height: 30px; margin-left: 12px;">
      </a>
      
      <a href="#">
      <img src="../img/footerlogo2.png" style="width: 30px; height: 30px; margin-left: 12px;">
      </a>
   </div>

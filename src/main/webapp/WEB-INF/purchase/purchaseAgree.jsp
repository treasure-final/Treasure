...
<div class="agree-wrapper">
	...
	<div class="hr"></div>
    	...
    	<div class="agree-ment"><b style="font-size: 1.1em; color: #747f55;">구매</b> 전 꼭 확인 해주세요</div>
    		
    	<div class="agree-check" id="agree-check">
    		<div>
    		<span>구매하려는 상품과 일치 합니다.</span><input type="checkbox" required="required" id="check1" class="chk"><label for="check1"></label>
    		</div>
    		...
    		<div>
    		<span>제조사에서 불량으로 인정하지 않는 기준은 하자로 판단하지 않습니다.</span><input type="checkbox" required="required" id="check3" class="chk"><label for="check3"></label>
    		</div>

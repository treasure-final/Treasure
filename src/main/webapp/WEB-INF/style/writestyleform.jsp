		...
		<form action="insert" method="post" enctype="multipart/form-data">
			...
			<div id="styleinsert">
				...
				<div id="stlyewrite">
					...
					<input style="border-bottom: 1px solid black;" type="text"
						name="board_subject " class="form-control" required="required"
						placeholder="제목" autofocus="autofocus"> 
					<input style="height: 240px;"  type="text" name="board_content"
...
( /* att_zone : 이미지들이 들어갈 위치 id, btn : file tag id */
        imageView = function imageView(att_zone, btn){
          ...
          var div_style = 'display:inline-block;position:relative;'
                        + 'width:150px;height:120px;margin:5px;border:1px solid #747f55;z-index:1';
          // 미리보기 이미지 속성
